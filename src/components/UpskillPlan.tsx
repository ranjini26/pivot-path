...
export const UpskillPlan = ({
  ...
  return <div className="space-y-6 animate-fade-in">
      ...
      <div className="space-y-6">
        {weeklyGoals.map((goal, index) => <Card key={index} className="glass-effect p-6">
            ...
            <div className="space-y-3 mb-4">
              {goal.resources.map((resource, resourceIndex) => <div key={resourceIndex} className="flex items-center justify-between p-3 bg-muted/30 rounded-lg border border-border/50">
                  <div className="flex items-center gap-3">
      ...
      <Card className="glass-effect p-6 text-center pivot-gradient bg-blue-950">
        <div className="text-white">
          <h3 className="font-semibold text-lg mb-2 text-zinc-50">Ready to start your transformation?</h3>
          <p className="text-white/90 mb-4 text-sm">
            Get daily check-ins, motivation, and personalized advice throughout your journey.
          </p>
          <Button onClick={onStartCoaching} className="bg-white/20 hover:bg-white/30 border-white/30 text-zinc-100">
